...
console.log(pricemydata);
    ...
    return(
        <>
          <div id="shoppage">
            <div style={{width:"1050px", paddingLeft:"20px",paddingTop:"20px", fontSize:"16px", fontWeight:"bold"}}>       
             <h5> Search By Category</h5> 
              <br/>
              <input type="radio" value="men" name="cat" onChange={(e)=>{setCatData(e.target.value)}} /> Mens Footwaers
              <br/>
              <input type="radio" value="women" name="cat"  onChange={(e)=>{setCatData(e.target.value)}} /> Womens Footwaers
